...
fn parse_input() -> (Vec<Vec<i64>>, Vec<String>) {
    let content: Vec<String> = fs::read_to_string("src/input.txt")
...
// Parsing for part 2
fn parse_zeroed_input() -> Vec<Vec<i64>> {
    let content: Vec<String> = fs::read_to_string("src/input.txt")
        .expect("Should have been able to read the file")
        .trim()
        .lines()
...
fn cephalopod_homework(operands: Vec<Vec<i64>>, operations: Vec<String>) -> i64 {
